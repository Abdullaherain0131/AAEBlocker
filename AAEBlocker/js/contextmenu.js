...
const onEntryClicked = function(details, tab) {
    ...
    if ( details.menuItemId === 'uBlock0-aaeTrainAd' ) {
...
const menuEntries = {
    ...
    aaeTrainAd: {
        id: 'uBlock0-aaeTrainAd',
        title: 'AAEBlocker: Bu Bir Reklamdır (Yapay Zekayı Eğit)',
        contexts: [ 'all' ],
        documentUrlPatterns: [ 'http://*/*', 'https://*/*' ],
    }
};
...
const update = function(tabId = undefined) {
    ...
    usedEntries.push(menuEntries.aaeTrainAd);
